...
# def save_train_details_all(cfg, exp_dir):
#     """
#     保存所有非空配置参数到带时间戳的 train_details.txt。
#     支持嵌套结构（如 cfg.model, cfg.train 等）。
#     """
...
#     print(f"✅ All configuration details saved to: {file_path}")
#     return file_path
