...
if __name__ == '__main__':
    ...
    file_list = ['2023120610']

    for file in file_list:
        input_path = os.path.join(args.velodyne_dir, file, 'velodyne_right')
        ...
        for point_cloud_name in input_point_clouds:
            ...
            np.savetxt(os.path.join(input_path[:-14]+'velodyne_right', point_cloud_name[:-4] + '.txt'), results, fmt='%.4f')